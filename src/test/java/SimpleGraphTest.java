...
public class SimpleGraphTest
{
    public static void main(String[] args)
    {
        ...
        JGraphTGraphVizWrapper.createGraphDOTFile("simple_graph.dot", graph, "shape=circle", JGraphTGraphVizWrapper.DEFAULT_PROPERTIES);
        JGraphTGraphVizWrapper.printGraph("neato", "-Goverlap=false", "simple_graph.dot", "pdf", "simple_graph");
    }
}
