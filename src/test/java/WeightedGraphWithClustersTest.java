...
public class WeightedGraphWithClustersTest
{
    public static void main(String[] args)
    {
        ...
        KSpanningTreeClustering<Integer, DefaultWeightedEdge> alg =
                new KSpanningTreeClustering<>(graph, k);
        ClusteringAlgorithm.Clustering<Integer> clustering = alg.getClustering();

        JGraphTGraphVizWrapper.createGraphDOTFile("weighted_graph_clusters.dot", graph, clustering, JGraphTGraphVizWrapper.DEFAULT_COLORS,"shape=circle", JGraphTGraphVizWrapper.DEFAULT_PROPERTIES);
        JGraphTGraphVizWrapper.printGraph("neato", "-Goverlap=false", "weighted_graph_clusters.dot", "pdf", "weighted_graph_clusters");
    }
}
